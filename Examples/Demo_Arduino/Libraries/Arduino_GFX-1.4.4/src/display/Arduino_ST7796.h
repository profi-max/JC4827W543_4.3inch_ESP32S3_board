...
static const uint8_t st7796_init_operations[] = {
    ...
    0x2B, 0x3C, 0x44, 0x4B, 0x1B,
    0x18, 0x17, 0x1D, 0x21,

    WRITE_COMMAND_8, 0xE1,
    WRITE_BYTES, 14,
    0xF0, 0x09, 0x13, 0x0C, 0x0D,
    0x27, 0x3B, 0x44, 0x4D, 0x0B,
    0x17, 0x17, 0x1D, 0x21,
...
static const uint8_t st7796_init_operations[] = {
    ...
    WRITE_C8_D16, 0xB1,  0x80, 0x10, //新增

    WRITE_COMMAND_8, 0xB5,

    WRITE_BYTES, 4, 0x1f, 0x50, 0x00, 0x20, //修改

    WRITE_COMMAND_8, 0xB6,

    WRITE_BYTES, 3,0x8a, 0x07, 0x3b, //新增

    WRITE_C8_D8, 0xB7, 0xC6,

    WRITE_C8_D16, 0xC0, 0x80, 0x64, //修改
    WRITE_C8_D8, 0xC1, 0x13, //修改
    WRITE_C8_D8, 0xC2, 0xA7,
    WRITE_C8_D8, 0xC5, 0x09, //修改
    ...
    WRITE_COMMAND_8, 0xE0,
    WRITE_BYTES, 14,
    0xF0, 0x06, 0x0B, 0x07, 0x06, 0x05, 0x2E, 0x33, 0x47, 0x3A, 0x17, 0x16, 0x2E, 0x31, //修改

    WRITE_COMMAND_8, 0xE1,
    WRITE_BYTES, 14,
    0xF0, 0x09, 0x13, 0x0C, 0x0D, 0x27, 0x3B, 0x44, 0x4D, 0x0B, 0x17, 0x17, 0x1D, 0x21, //修改

    WRITE_C8_D8, 0xF0, 0x3C,
    WRITE_C8_D8, 0xF0, 0x69,

    WRITE_COMMAND_8, 0x2A,
    WRITE_BYTES, 4, 0x00, 0x00, 0x01, 0x3F, //新增

    WRITE_COMMAND_8, 0x2B,
    WRITE_BYTES, 4, 0x00, 0x00, 0x01, 0xDF, //新增

    WRITE_C8_D8, 0xB7, 0x00, //新增
